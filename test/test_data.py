...
class RepoTest(unittest.TestCase):
    ...
    def test_get_repo_target_path_correct(self):
        repo = Repo('/foo/blub')
        self.assertEqual('/tmp/blub', repo.get_repo_target_path('/foo/', Target('/tmp')))
...
class HgRepoTest(unittest.TestCase):
    ...
    def test_parse_remote_valid(self):
        self.assertEqual('https://server.com/user/repo', HgRepo.parse_remote(HgRepoTest.HG_PATHS_DEFAULT_LINE))
